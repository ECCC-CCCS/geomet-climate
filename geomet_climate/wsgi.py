...
def metadata_lang(m, lang):
    ...
    m.setMetaData('ows_address',
                  m.getMetaData('ows_address_{}'.format(lang)))
    m.setMetaData('ows_contactperson',
                  m.getMetaData('ows_contactperson_{}'.format(lang)))
    m.setMetaData('ows_city',
                  m.getMetaData('ows_city_{}'.format(lang)))
    m.setMetaData('ows_country',
                  m.getMetaData('ows_country_{}'.format(lang)))
    m.setMetaData('ows_keywordlist_http://purl.org/dc/terms/_items',
                  m.getMetaData('ows_keywordlist_http://purl.org/dc/terms/_items_{}'.format(lang))) # noqa
    m.setMetaData('wms_attribution_title',
                  m.getMetaData('wms_attribution_title_{}'.format(lang)))
    m.setMetaData('ows_contactinstructions',
                  m.getMetaData('ows_contactinstructions_{}'.format(lang)))
    m.setMetaData('ows_contactposition',
                  m.getMetaData('ows_contactposition_{}'.format(lang)))
    m.setMetaData('ows_contactorganization',
                  m.getMetaData('ows_contactorganization_{}'.format(lang)))
    m.setMetaData('wms_attribution_onlineresource', m.getMetaData(
        'wms_attribution_onlineresource_{}'.format(lang)))
    m.setMetaData('ows_onlineresource',
                  m.getMetaData('ows_onlineresource_{}'.format(lang)))
    m.setMetaData('ows_abstract',
                  m.getMetaData('ows_abstract_{}'.format(lang)))
    m.setMetaData('ows_service_onlineresource',
                  m.getMetaData('ows_service_onlineresource_{}'.format(lang)))
    m.setMetaData('ows_title',
                  m.getMetaData('ows_title_{}'.format(lang)))
    m.setMetaData('ows_hoursofservice',
                  m.getMetaData('ows_hoursofservice_{}'.format(lang)))
    m.setMetaData('ows_stateorprovince',
                  m.getMetaData('ows_stateorprovince_{}'.format(lang)))
    m.setMetaData('ows_keywordlist',
                  m.getMetaData('ows_keywordlist_{}'.format(lang)))
    m.setMetaData('wcs_description',
                  m.getMetaData('wcs_description_{}'.format(lang)))
